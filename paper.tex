...
Prediction using only the random forest takes 33ms on average, while segmentation and prediction
using the structural SVM approximately take an additional 500ms.
...
\begin{figure}
    \begin{center}
        \includegraphics[width=.45\linewidth]{images/vertical_alignment}
    ...
    \caption{%
        ...
        image. See \secref{results} for details.
    \figlabel{weights}}
    \vspace{-6mm}
\end{figure}
