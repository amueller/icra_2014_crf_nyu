...
\begin{abstract}
    ...
    %We demonstrate how conditional random field learning, an approach
...
\citet{silberman2011indoor} captured a wide variety of indoor scene using a structured light sensor,
...
\begin{description}
    ...
    \item[Normal Orientations] \hfill \\
        ...
        The feature is illustrated in \Figref{normal_feature}. The difference
...
\Figref{comparison}, which shows prediction results on the test set.  The for
...
\begin{figure*}
    ...
    \multicolumn{5}{@{}c@{}}{Random Forest Prediction}\\
    ...
    \multicolumn{5}{@{}c@{}}{Superpixel Voting}\\
    ...
    \multicolumn{5}{@{}c@{}}{Support Vector Machine on Superpixels}\\
    ...
    \multicolumn{5}{@{}c@{}}{Conditional Random Field on Superpixels}\\
...
While our approach allows modeling of spacial relations, these are limited to
